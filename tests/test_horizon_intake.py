...
import scripts.build_project_console as console_builder
from scripts.build_project_console import (
...
CANDIDATE_SOURCE_DEVELOPMENT = RESEARCH / "candidate-source-development"
...
class HorizonIntakeTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        participation_prefix = "/* Generated by scripts/build_project_console.py. */\nwindow.ARRP_PARTICIPATION_DATA="
                ...
                writer.writerows(
                    [
                        ...
                        },
                        {
                            ...
                            "Canonical Record": (
                                "framework/logs/candidates/candidate-discovery-log.md"
                            ),
                            "Parent GitHub Number": "",
                        },
                        {
    ...
    def test_private_security_projection_is_written_after_public_bundle_swap(
        ...
        builder_source = (
            ROOT / "scripts" / "build_project_console.py"
...
"""
    ...
    def test_console_navigation_and_current_record_accounting_are_complete(self) -> None:
        html = (PROJECT_CONSOLE / "project-console.html").read_text(
            encoding="utf-8"
        )
            ...
            if record["id"] in {"elim", "agents"}:
                ...
                self.assertTrue(
                    record["source_url"].startswith(
                        "https://github.com/Thorncrag/ARRP/blob/main/framework/logs/"
                    )
                )
        for record in self.console["project_logs"]:
    ...
    def test_horizon_source_records_state_candidate_specific_questions(self) -> None:
        ...
        records = sorted(
            CANDIDATE_SOURCE_DEVELOPMENT.glob("HOR-*-source-development.md")
        )
    ...
    def test_development_lifecycle_has_six_maturity_levels_only(self) -> None:
        ...
        console = (
            PROJECT_CONSOLE / "project-console.html"
        ).read_text(encoding="utf-8")
