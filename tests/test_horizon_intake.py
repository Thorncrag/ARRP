...
class HorizonIntakeTest(unittest.TestCase):
    ...
    def test_standalone_submission_prototype_has_minimal_lookup_and_page_context(self) -> None:
        ...
        self.assertIn("catalog-data.js?v=38", console_html)
        self.assertIn("data/candidates.js?v=38", console_html)
        self.assertIn("data/automation.js?v=38", console_html)
        self.assertIn("app.js?v=38", console_html)
        self.assertIn("styles.css?v=38", console_html)
