...
The American system of government suffered serious failures because its safeguards did not adequately constrain conduct by President Trump and MAGA-aligned actors that placed personal loyalty above constitutional duty, institutional independence, factual adjudication, and the peaceful transfer of power. The damage must be repaired, the weaknesses that enabled it must be corrected, and stronger safeguards must be established against future personalist capture. This diagnosis is an explicit ARRP position with clear present political implications.

ARRP examines President Trump's conduct because of the institutional weaknesses it revealed or exploited—not merely because the project disagrees with a policy or political position. The same standards apply to any officeholder.

[Project 2025](topics/project-2025.md) is a policy, personnel, administrative, and institutional program associated with the MAGA-aligned Republican political coalition. ARRP's criticism of portions of that program therefore has politically uneven implications and may reasonably be perceived as partisan. The project acknowledges that perception while evaluating Project 2025 and comparable programs according to their legal and institutional mechanisms rather than their partisan source. It does not treat Project 2025 as a single institutional failure or presume that every recommendation it contains is objectionable.
...
ARRP takes the substantive position that maximalist unitary executive theory is fundamentally flawed when it converts presidential control into authority to displace powers assigned to Congress or the courts, defeat statutory limits, or insulate executive action from meaningful review. That position has clear present political implications because Project 2025 and MAGA-aligned arguments prominently rely on broad presidential-control claims. ARRP's objection rests on the resulting institutional structure, not Republican affiliation, and applies equally to comparable claims advanced by any president.
...
This project is independent of political parties and party-neutral in its evidentiary, legal, and remedial standards, but it is not positionless. It opposes institutional abuse, democratic backsliding, corruption, personalist capture, rule-of-law failure, maximalist unitary executive theory, and efforts to subordinate public institutions to personal or factional control. Some of those positions have uneven consequences in present politics and may reasonably be perceived as aligned against President Trump, MAGA-aligned actors, or Project 2025. The project should acknowledge that perception where material, distinguish documented facts and governing law from disputed interpretations and ARRP's own judgments, and explain the institutional basis for each position. Proposed remedies are meant to apply prospectively and evenhandedly across parties, officeholders, and political circumstances.
