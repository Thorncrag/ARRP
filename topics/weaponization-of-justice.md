...
status: maintained
purpose: "Help readers find the ARRP proposals addressing political misuse of federal investigation, prosecution, enforcement, personnel, and supervisory authority."
...
The project’s detailed source-to-proposal treatment of politically sensitive investigations, source vetting, FISA accuracy, internal challenge functions, and competing official assessments is retained in the [Durham Report / ARRP Crosswalk](https://github.com/Thorncrag/ARRP/blob/main/research/durham-report-arrp-crosswalk.md). The crosswalk treats the report as a source-development and remedy-stress record rather than an adjudicated finding.
