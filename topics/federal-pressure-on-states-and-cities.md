...
status: maintained
purpose: "Help readers find the ARRP proposals addressing federal funding pressure, selective enforcement, displacement of State functions, force deployments, election interference, and retaliatory investigations."
...
| Deploying federal forces over State objection | [DOM-001](../areas/DOM/issues/DOM-001.md) | Addresses authority, findings, notice, duration, and review. |
