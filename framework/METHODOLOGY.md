...
1. **Style, section-fit, and concision audit.** Begin with the [Formatting Preflight](#formatting-preflight). Confirm that the issue follows the project's style and architecture conventions, that each main section contains material appropriate to its function, and that the main narrative is as concise as reasonably possible while still establishing the issue and proposed remedy. Apply this as an editorial guideline rather than a hard word-count or section-length rule. At audit closeout, repeat the check briefly so material added during the audit does not introduce new style, section-placement, or concision problems.
...
9. scoring annotations mirror visible scoring labels where practical, including **Quality Score**, **Adoption Score**, **Coalition Support Estimates**, **External Review Status**, **Adoption Friction**, **Required Electoral Environment**, and **Development Priority** when those fields appear; and
