...
5. **Manifestation of the Failure** uses concise, evidence-backed titled examples or observable categories. Abstract coverage definitions, remedy tiers, hypothetical design risks, and uncited restatements of the institutional anomaly should instead appear in **Underlying Weakness**, **Repair and Prevention**, or **Annotation**, as appropriate;
