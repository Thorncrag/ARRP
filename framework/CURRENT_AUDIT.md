...
| Completed steps | Created ELEC-014 criminal-process catalog; expanded manifestations for Ohio, Georgia Fulton County search/seizure, Georgia analyst surge, Fulton County grand-jury subpoena, July 2026 DOJ prosecution-warning letters, and unresolved Arizona subpoena lead; added source rows SRC-0523 through SRC-0531; clarified that civil/administrative state-election-record demands are boundary material outside ELEC-014 unless a criminal-process hook is verified; added alleged-statute/offense-theory column for criminal-process entries; updated issue metadata, audit history, area page, GitHub issue wrapper, and GitHub Project fields without making motive or legitimacy findings. |
| Next step | Obtain primary warrants, returns, subpoenas, orders, DOJ letters, state responses, and Arizona lead verification, with exact alleged statutes or offense theories for each criminal-process item; then run T2 remedy-selection and legitimacy assessment. |
