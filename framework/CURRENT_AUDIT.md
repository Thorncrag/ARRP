...
| Files touched | `framework/CURRENT_AUDIT.md`; `source-development/ELEC-014-criminal-process-catalog.md`; `source-development/ELEC-004-civil-process-catalog.md`; `areas/ELEC/README.md`; `areas/ELEC/issues/ELEC-014.md`; `areas/ELEC/issues/ELEC-014.audit.md`; `areas/ELEC/issues/ELEC-004.md`; `areas/ELEC/issues/ELEC-004.audit.md`; `inventory/sources.csv`; GitHub issues #236/#32 and Project item fields. |
