...
5. confirm hosted settings, publication checks, branch protection, and final
   human authorization;
6. preserve the final manifest, checksums, build provenance, and readback; and
7. publish concise release notes that distinguish completed, draft, and
   unresolved work.
