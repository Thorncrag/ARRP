...
1. one agent checking source sufficiency while another checks
   hosted-workflow/source-catalog consistency;
2. one agent surveying prior proposals while another checks
...
final consistency checks, validating the complete worktree, and handling
