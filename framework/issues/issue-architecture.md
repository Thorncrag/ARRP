...
dependencies: "../FRAMEWORK.md; ../methodology/scope-and-admission.md; ../methodology/neutrality-and-language.md; ../evidence/annotation-and-source-standards.md; ../REMEDY_FRAMEWORK.md"
...
This file is the authoritative detailed standard for canonical issue-page architecture. The guiding principle and human-authority boundary in [`../FRAMEWORK.md`](../FRAMEWORK.md) control. Apply [`../methodology/scope-and-admission.md`](../methodology/scope-and-admission.md) to issue identity and scope, [`../methodology/neutrality-and-language.md`](../methodology/neutrality-and-language.md) to prose, [`../evidence/annotation-and-source-standards.md`](../evidence/annotation-and-source-standards.md) to support, and [`../REMEDY_FRAMEWORK.md`](../REMEDY_FRAMEWORK.md) to remedy classification. Load [`../INTERBRANCH_REVIEW_FRAMEWORK.md`](../INTERBRANCH_REVIEW_FRAMEWORK.md) additionally when JUD-011 coverage or independent-pathway presentation is implicated; those rules are not restated here.
...
Apply the specialized JUD-011 coverage and two-pathway presentation rules in [`../INTERBRANCH_REVIEW_FRAMEWORK.md`](../INTERBRANCH_REVIEW_FRAMEWORK.md) whenever that framework is implicated.
