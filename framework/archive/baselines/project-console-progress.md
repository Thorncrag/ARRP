...
- [`framework/project/interfaces/project-console/`](../../../framework/project/interfaces/project-console/) owns the sole human-facing visualization, including the trajectory graph.
