...
| Stop reason | Mandatory fail-closed usage stop: the official post-unit reading reported that the applicable `codex:primary` window reset during the run. The last bounded operation had already been validated, merged, synchronized, and read back. |
