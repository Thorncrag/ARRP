...
The [Framework](../../FRAMEWORK.md), [Agent Operating Rules](../../AGENT_OPERATING_RULES.md), [Project Interface](../../project/interfaces/project-console/specification.md), [Project Console Progress](../../project/interfaces/project-console/configuration/progress.md), [GitHub Workflow](../../project/github/workflow.md), and registered agent and bot runbooks remain controlling. The Console remains a read-only projection except for the explicitly bounded localhost coordinator requests and locally staged publication plans described by those authorities.
