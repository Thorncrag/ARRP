...
The [Framework](../../framework/FRAMEWORK.md), [Agent Operating Rules](../../framework/AGENT_OPERATING_RULES.md), [Project Interface](../../framework/project/interfaces/project-console.md), [Project Console Progress](../../framework/project/interfaces/project-console-progress.md), [GitHub Workflow](../../framework/project/github/workflow.md), and registered agent and bot runbooks remain controlling. The Console remains a read-only projection except for the explicitly bounded localhost coordinator requests and locally staged publication plans described by those authorities.
