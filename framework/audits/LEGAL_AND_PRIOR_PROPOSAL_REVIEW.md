...
status: active
dependencies: "AUDIT_CORE.md; VERIFICATION_PROTOCOL.md; TIERED_AUDITS.md; ../REMEDY_FRAMEWORK.md"
print_status: excluded
print_exclusion_reason: "Online technical framework and methodology."
---

# Legal and Prior-Proposal Review

## Authority, Loading, and Dependencies

**Authority.** This module is authoritative for judicial and scholarly scrutiny, existing-law and prior-proposal preference, legislative-support signals, and direct and functional analogue review.

**Load when.** Load this module whenever an audit evaluates constitutional or statutory authority, litigation durability, judicial or scholarly objections, existing legal vehicles, prior bills or institutional models, functional analogues, or a proposal's readiness for T2 through T4 review.

**Dependencies.** Load the [Framework kernel](../FRAMEWORK.md), [Audit Core](AUDIT_CORE.md), [Verification Protocol](VERIFICATION_PROTOCOL.md), and [Remedy Framework](../REMEDY_FRAMEWORK.md). Load [Tiered Audit and Formatting Requirements](TIERED_AUDITS.md) to determine the depth required by the selected tier.
