...
- [`CHANGE_AUDIT_LOG.md`](CHANGE_AUDIT_LOG.md) and [`PROJECT_CONSISTENCY_AUDIT.md`](PROJECT_CONSISTENCY_AUDIT.md) are retained read-only historical records; future durable audit lessons are incorporated in the files that own them.
...
- [`CHANGE_AUDIT_LOG.md`](CHANGE_AUDIT_LOG.md) and [`PROJECT_CONSISTENCY_AUDIT.md`](PROJECT_CONSISTENCY_AUDIT.md) — read-only historical audit records
