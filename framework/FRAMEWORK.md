...
[`../topics/`](../topics/) supplies a selective reader-oriented layer for major subjects of public interest that span multiple institutional failures, areas, or remedies and materially benefit from explanatory synthesis. [`../topics/README.md`](../topics/README.md) is the concise guide index displayed beside the Subject and Institution Index at the public front door. Topic pages are nonauthoritative routing surfaces: they briefly identify the subject, map readers to records that own the analysis, identify materially related rejected or outside-scope concepts when a final adverse decision exists, and distinguish institutional defects from ordinary political disagreement. Deferred records remain ordinary live routes, while merged or integrated records appear only through their current authoritative homes. Topic pages do not own diagnoses, manifestations, legal or remedy analysis, legislation, scores, audits, live status, budgets, priorities, or development tasks. Their visible titles and site-navigation labels use the subject's commonly known public name. Each subject has one canonical page; an existing ARRP crosswalk selected for topic treatment is converted and moved rather than duplicated. Admission, required sections, the verbatim-transfer ownership test, rejection handling, source discipline, and concision rules are maintained in the [Topic Page Standard](METHODOLOGY.md#topic-page-standard).
