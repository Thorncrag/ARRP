...
[`../SUBJECT_INDEX.md`](../SUBJECT_INDEX.md) is a many-to-many discovery layer over those stable areas and issues. It may route a reader from an organization, acronym, institutional body, or plain-language subject to the primary analytical home and material cross-references, but it does not create issue ownership or duplicate status, score, priority, audit, or roadmap fields. Update it when proposal development or material source integration introduces a useful new lookup term or changes a term's primary home. Its stable links and identifiers also provide the source keys from which the print-assembly process generates edition-specific page locators.
