...
7. ensure rapid reporting and legal-basis certification when emergency defensive action is taken;
8. prevent appropriations, procurement, logistics support, or general defense funding from being treated as implied authorization for hostilities unless Congress expressly so provides;
9. create clear funding consequences for unauthorized hostilities after a short emergency period;
10. provide Congress with expedited procedures for authorizing, disapproving, or terminating covered operations; and
11. create statutory consequences capable of operating even where judicial enforcement is uncertain.
...
- The draft currently contains front-end initiation, emergency-defense, reporting, funding, presentment, and anti-implied-authorization provisions.
- Further expansion should add more detailed provisions on automatic termination, AUMF specificity and sunsets, executive legal-interpretation disclosure, pre-authorization information, mission-expansion triggers, and appropriations doctrine.
