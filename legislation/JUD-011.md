...
“(4) A judge may be placed on the roster only after obtaining any consent required by section 295. The Chief Justice shall make each designation and assignment required to implement a random selection under this subsection. Such designation and assignment is authorized directly by this section, does not depend on a case-specific request or certificate of necessity under section 291 or 292, and is subject to sections 295 and 296 except to the extent that a provision of those sections is inconsistent with this section.
