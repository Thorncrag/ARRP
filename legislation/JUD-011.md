...
“(1) determine whether the action invokes section 2303 and whether the claim is so wholly insubstantial or frivolous that it fails to present a federal question, but may not dismiss for ordinary failure to state a claim, resolve the merits of section 2303(b), or enter judgment on the merits;
...
- The single D.D.C. judge may reject only a claim so wholly insubstantial or frivolous that it does not present a federal question; ordinary failure-to-state-a-claim and merits questions belong to the three-judge panel. Emergency preservation tracks section 2284(b)(3), and masters remain governed by rule 53 and section 2284.
...
- Source development includes 28 U.S.C. §§ 133, 144, 291–296, 455, 1253, 1291, 1292, 1367, 1657, 2071, 2072, 2107, and 2284; the Federal Rules of Civil Procedure; D.D.C. and D.C. Circuit local rules; and Judicial Conference assignment and intercircuit-designation practices. T4 should verify the final text against the complete current Code and rules immediately before circulation.
...
- Constitutional review should address Article III case-or-controversy requirements, congressional standing, statutory standing, sovereign immunity, judicial assignments, nonadjudicatory judicial functions, appointments, due process, direct review, relief involving the President, and the subordinate-officer redress recognized in *Severino v. Biden*.
- Current-case review should refresh *National Treasury Employees Union v. Vought*, *Department of State v. AIDS Vaccine Advocacy Coalition*, and any later Supreme Court or D.C. Circuit matter affecting reviewability, statutory preclusion, removal, agency dismantling, appropriations enforcement, or remedial scope.
