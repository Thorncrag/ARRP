...
2. an order granting, denying, modifying, or dissolving a temporary restraining order or preliminary injunction may be appealed under section 1292 of title 28 not later than 10 days after entry;
...
- T1 removed the unsupported fixed startup and annual direct-appropriation placeholders. T2 identified agency-inventory, GAO, inspector-general, Judiciary, protected-record, discovery, and compliance workload categories, but no source supports a fixed incremental amount. Fixed amounts should be considered only after AOUSC, representative-agency, GAO, inspector-general, and CBO review.
