...
This proposed enabling legislation depends on ratification of the [Independent Investigative Counsel Amendment](DOJ-007-amendment.md).
...
- T4 should source-check grand-jury disclosure mechanics, limitations-period tolling analogues, protected-appropriation models, and current pending removal-power cases before publication.
