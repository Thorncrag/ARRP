...
This proposed enabling legislation depends on ratification of the [Independent Investigative Counsel Amendment](DOJ-007-amendment.md). It is the complete independent alternative for Congress to enact if it does not enact JUD-011 and the preferred [Interbranch implementation Act](DOJ-007-preferred.md).
...
## Budgetary Impact Statement — Independent Alternative
...
- This bill is the independent DOJ-007 alternative. It neither invokes nor depends on JUD-011 and supplies its own judicial roster, Special Division, administration, funding, appointment, investigation, removal, reporting, and review authority.
- The preferred [DOJ-007 Interbranch implementation Act](DOJ-007-preferred.md) uses JUD-011's shared judicial infrastructure but is not required for this bill to operate.
