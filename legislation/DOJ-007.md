...
- T3 should source-check Watergate reporting history, limitations-period tolling analogues, protected-appropriation models, and current pending removal-power cases before external circulation.
