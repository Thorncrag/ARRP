...
To require prompt congressional notice and a public status record when a Federal court finds material or willful noncompliance by the United States or a Federal executive entity or officer with an operative judicial order.
...
Chapter 21 of title 18, United States Code, is amended by adding at the end the following:

## “§ 404. Notice of qualifying executive-noncompliance findings

### “(a) Definitions.

“In this section:

“(1) **Covered executive party.**—The term ‘covered executive party’ means the United States, an executive department, a military department, a Government corporation, an independent establishment, an agency, or an officer or employee of the United States acting or sued in an official capacity.
...
“(3) **Status event.**—The term ‘status event’ means a stay, administrative stay, reversal, vacatur, modification, clarification, superseding finding, satisfaction, purge, or express judicial determination of compliance affecting a qualifying finding or the underlying command.
...
“(4) the chair and ranking minority member of each committee identified by the court as having jurisdiction over the covered executive party, program, appropriation, or subject matter;
...
“Not later than 2 business days after the clerk receives notice of a status event, the clerk shall transmit notice of that event to each recipient identified in subsection (b).
...
“(26) establish and maintain a free, searchable, downloadable, and durable online register of the public materials transmitted under section 404 of title 18, which shall—
...
“(E) publish only the public version or docket statement supplied by the clerk and disclose no information protected under section 404(d) of title 18; and
...
- The draft adds a reporting provision to the existing contempt chapter but does not alter the contempt power in [18 U.S.C. § 401](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title18-section401&num=0&edition=prelim).
...
- T1 should test whether section 404 is the best codification, whether the definition of a covered executive party should track a single existing definition, whether two business days is operationally workable, and whether congressional recipient and protected-transmission language needs legislative-counsel revision.
