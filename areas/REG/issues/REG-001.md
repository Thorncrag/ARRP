...
> ## Issue Snapshot
> **Problem:** Independent-agency removal protection is unstable.<br />**Repair:** Identify constitutionally durable independence safeguards.<br />**Vehicle:** Pending source development.
>
...
REG-001 should therefore assess what independence safeguards remain legally available, whether any agencies are distinguishable from the FTC, and whether a constitutional amendment is the only durable way to preserve commission-style independence.
...
**Constitutional amendment.** Assess whether durable protection for independent multimember regulatory commissions requires an amendment authorizing Congress to create specified independent agencies with limited removal protection.
...
The least-complex adequate remedy is not selected. REG-001 should begin with source development after *Slaughter*, including agency-by-agency exposure analysis and separation between constitutional amendment options and ordinary statutory mitigation. That review should apply the project's unitary-executive consolidation principle: if multiple issues stem from the same Article II theory, a single amendment package may be preferable to isolated issue-by-issue amendments.

A narrow first-stage remedy could focus on non-removal safeguards: written removal notices, congressional reporting, continuity rules, adjudicatory separation, records preservation, and expedited review of collateral statutory issues. A durable independence remedy may require a constitutional amendment if the goal is to restore for-cause removal protection for covered commissions.
...
4. strengthen internal adjudicatory independence and review procedures;
5. adjust quorum, vacancy, holdover, and term-staggering rules to reduce abrupt capture;
6. preserve agency records and decisional explanations during leadership changes;
7. develop agency-specific statutory mitigations where removal protection is unavailable; and
8. consider whether durable commission independence should be part of a broader constitutional amendment addressing unitary-executive constraints across multiple proposals.
