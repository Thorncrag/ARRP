...
| 2026-07-10 | EAC (Election Assistance Commission) | Reported removals plus vacancies | Reported left without members; organic structure and pre-event baseline verified | [4](#t1-eac) |
...
Where DOGE/USDS or another repurposed cross-agency unit is the mechanism, this catalog records the effect on the target institution; [CIV-009](../../CIV/README.md) separately owns the unit's authority, appointments, delegations, systems access, privacy, records, procurement, appropriations, and oversight design. Cross-reference both only when the evidence supports both defects.
...
Thomas Hicks and Benjamin Hovland were reportedly removed after Donald Palmer had stepped down and Christy McCormick resigned, reportedly leaving the four-member commission without commissioners. The organic statute verifies four Senate-confirmed members, political-balance and congressional-recommendation rules, fixed terms, and service after term expiration until a successor takes office. The EAC officially confirmed Palmer's April 30 departure; its commissioner page dated May 1 still listed Hicks, McCormick, and Hovland when reviewed after the reported July event and is therefore only a pre-event baseline. The later removal notices, resignation record, updated roster, quorum rule, and post-*Slaughter* legal effect still require primary verification. REG-001 owns the independence and continuity problem; ELEC-001 and ELEC-013 receive election-administration and candidate-access cross-references. Sources: U.S. Code, [52 U.S.C. § 20923](https://uscode.house.gov/view.xhtml?req=%28title%3A52+section%3A20923+edition%3Aprelim%29); EAC, [commissioner roster](https://www.eac.gov/about/commissioners) and [Palmer departure announcement](https://www.eac.gov/news/2026/04/29/eac-announces-commissioner-donald-palmer-departing-agency); Associated Press, [*Donald Trump ousts election commission members in latest push to reshape US voting process*](https://apnews.com/article/0dc1f37c3990398b3085f22a14ea239a).
