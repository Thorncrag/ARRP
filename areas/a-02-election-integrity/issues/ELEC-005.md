...
issue_id: ELEC-005
area_id: A-02
title: "Weak Safeguards Against False Presidential-Elector Certificates"
status: developed
priority: high
...
# ELEC-005 — Weak Safeguards Against False Presidential-Elector Certificates

## Institutional Anomaly

Federal presidential-election law relies on state-issued elector certificates and related documents entering a federal receipt and counting channel, but it does not expressly define a purpose-built federal offense or civil enforcement mechanism for knowingly submitting, transmitting, filing, presenting, delivering, or using false or unauthorized presidential-elector documents in that federal channel.

The problem is not that existing fraud, forgery, false-statement, obstruction, conspiracy, or state-law remedies are unavailable in every case. The problem is that those remedies are retrospective, uneven, element-specific, and not expressly designed to protect the federal presidential-elector certificate channel before false documents can be used as procedural or political leverage.
...
### Contingent-elector ambiguity

A narrow category of contingent elector activity may be legitimate where a real recount, contest, or litigation proceeding remains unresolved and the document is clearly conditional and nonoperative. The absence of clear federal labeling and transmission rules permits abusive documents to mimic lawful certificates while claiming after the fact to be merely contingent.

### Transmission and official-receipt vulnerability

False or unauthorized elector documents become most dangerous when sent to Congress, the President of the Senate, the Archivist, NARA, federal courts, or other federal recipients. Without explicit receipt duties, such documents may be preserved, circulated, cited, or publicly described in a way that creates legal uncertainty or supports pressure on federal actors.

## Resulting Damage

False or unauthorized presidential-elector documents can manufacture ambiguity, support congressional objections, pressure federal officials, create public confusion, burden courts and election officials, and provide a predicate for efforts to obstruct or distort the lawful electoral count.

## Underlying Weakness

Existing law may lack:

- a Title 3-specific prohibition on false or unauthorized presidential-elector documents entering federal channels;
- a clear definition of unauthorized presidential-elector documents;
...
Congress should amend chapter 1 of title 3, United States Code, by adding a new section, likely 3 U.S.C. § 12A, governing false or unauthorized presidential-elector documents submitted or used in federal channels.

The federal amendment should:

1. apply only when a false or unauthorized presidential-elector document is transmitted, submitted, filed, presented, delivered, or used in a federal channel;
2. leave state elector appointment, recount, contest, canvass, and certification procedures to state law before federal transmission;
3. define unauthorized presidential-elector documents;
4. protect clearly labeled contingent elector documents prepared solely to preserve lawful claims in pending proceedings;
...
- [Presidential Elector Certificate Integrity Amendments](../../../legislation/ELEC-005.md)
