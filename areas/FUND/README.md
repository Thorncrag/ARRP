...
- [FUND-001 — Addressing Executive Order Abuse](issues/FUND-001.md) _(status: Review Ready; T4 score: 83; priority: Medium)_
...
FUND-001 has completed cumulative T4 publication-ready review at 83/100 (Review Ready); further advancement requires qualified appropriations, federal-courts, budget, program-administration, and legislative-counsel review plus proposal-specific workload evidence and a current-litigation refresh before circulation. FUND-002 has a candidate issue framework. Remaining FUND issues remain provisional inventory pending full source development.
