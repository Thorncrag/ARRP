...
- **ELEC-013** concerns federal candidate-access, ballot-access, and debate-gatekeeping rules that can entrench dominant-party control or suppress nonstandard candidacies through debate criteria, polling thresholds, state ballot-access burdens, petition-defect rules, cure limits, public-benefit debate structures, or weak FEC-facing transparency. After the July 6, 2026 boundary split, ranked-choice voting and majority-choice election-method design are no longer owned here. ELEC-013 should draft a federal candidate-access and debate-gatekeeping bill using Ross Perot's 1992 debate inclusion as the modern case-study anchor, focused on debate-transparency/public-benefit conditions, alternative qualification paths, federal-election ballot-access notice-and-cure floors, FEC administration, and constitutional-authority mapping. A source-development explanatory checklist now maps the presidential debate and state-by-state ballot-access pathway. See [ELEC-013](issues/ELEC-013.md) and [the checklist](../../source-development/ELEC-013-presidential-debate-ballot-access-explainer.md).
- **ELEC-014** concerns federal criminal investigative process directed at state-administered elections, election officials, voter-registration activity, voter data, ballots, voting systems, or voting-rights organizations. It is distinct from ELEC-004 because it concerns criminal searches, criminal subpoenas, grand-jury process, law-enforcement interviews, device seizures, and criminal investigative data demands rather than civil litigation or Anti-SLAPP-style election proceedings. See [ELEC-014](issues/ELEC-014.md).
...
ELEC-001, ELEC-002, ELEC-003, ELEC-004, ELEC-005, ELEC-006, ELEC-007, ELEC-008, ELEC-009, ELEC-010, ELEC-011, and ELEC-012 are developed. ELEC-013's last audit remains the July 6, 2026 boundary split and targeted Change Audit; July 9, 2026 source-development checkpoints queued the Perot 1992 case study and added a presidential debate / state ballot-access explanatory checklist, and ELEC-013 remains a fixed-zero candidate pending federal candidate-access and debate-gatekeeping draft legislation. ELEC-014 has completed T1 issue-admission/source-development review but remains a candidate pending T2 remedy selection and legislation or policy drafting. ELEC-015 has been branched from ELEC-013 and remains a fixed-zero candidate pending remedy selection and model-state or federal voluntary-pilot draft text.
