...
> **Living research record:** This catalog supports [ELEC-004 issue #32](https://github.com/Thorncrag/ARRP/issues/32) and is reviewed through that proposal's issue-level monitoring.
...
1. Obtain DOJ letters, county/state responses, complaints, motions, orders, protective-order materials, and settlement or dismissal records for each civil demand or lawsuit.
2. Build a state-by-state table that distinguishes requests, lawsuits, voluntary productions, refusals, dismissals, protective orders, and pending cases.
3. Identify whether each demand was civil/administrative, Voting Section, Criminal Division, grand-jury, warrant-based, or prosecution-threat material.
4. Move any item with a verified warrant, grand jury, criminal subpoena, federal criminal investigation, or prosecution-threat hook to ELEC-014 or cross-reference it there.
5. Evaluate how civil voter-data and election-record demands interact with ELEC-004's Anti-SLAPP-style screening, discovery stay, protective-order, narrowing, quashing, and sanctions architecture.
