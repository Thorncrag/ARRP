...
**Budget Analogues.** The conservative fiscal range is not an official score. It is bounded by administrative-process analogues rather than major election-modernization grants: [CBO's H.R. 4228 estimate](https://www.cbo.gov/publication/45385) is a low-end comparator for reporting, review, and administrative-process duties; [CBO's H.R. 9 estimate](https://www.cbo.gov/publication/50063) is a higher administrative/rulemaking/database comparator; and [AP's 2024 election-security funding report](https://apnews.com/article/331bcd11694e702efbee6f31bee03faf) is used only as an upper-scale contrast for broad election-security grants, not as the expected cost of ELEC-013.
