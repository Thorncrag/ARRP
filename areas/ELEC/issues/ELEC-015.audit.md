...
**Scope:** Created a dedicated Maine source-development file at [ELEC-015 Maine RCV Participation Data](../../../source-development/ELEC-015-maine-rcv-participation-data.md) and linked it from the issue page. The file starts the Maine candidate-participation and voter-participation extraction with official Secretary of State sources. Its core comparison model tracks the election referenced, office or contest, RCV status, number of candidates, voter turnout or ballots cast, and comparability notes. Election outcome is not treated as a core field; RCV activation, round count, and exhausted ballots are preserved only as secondary ballot-experience context. The next extraction checklist covers candidate lists, withdrawals, first-choice files, cast-vote records, non-RCV comparators, and prior-cycle results.
