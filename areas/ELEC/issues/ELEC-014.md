...
ELEC-014 should begin from a complete criminal-process catalog before judging motive or legitimacy. The current source-development catalog is [ELEC-014 Criminal-Process and State Election Records Catalog](../../../research/ELEC-014-criminal-process-catalog.md), maintained through [GitHub sub-issue #243](https://github.com/Thorncrag/ARRP/issues/243). It tracks core criminal probes, warrants, grand-jury subpoenas, criminal subpoenas, prosecution-warning letters, and unresolved criminal-process leads. Noncriminal state-record demands now live in [ELEC-004 Civil Process and State Election Records Catalog](../../../research/ELEC-004-civil-process-catalog.md), with ELEC-001 or ELEC-010 cross-references where federal election-control or voter-data architecture is central, unless a criminal-process hook is verified.
...
- Source-development catalog: [ELEC-014 Criminal-Process and State Election Records Catalog](../../../research/ELEC-014-criminal-process-catalog.md).
...
- Associated Press, [*Sweeping review of grand jury presentations underway in Chicago following misconduct revelations*](https://apnews.com/article/c2c61795c49a45d17cc8de077882f7d6) (July 1, 2026) (adjacent DOJ grand-jury-integrity pattern source; not an election-process manifestation).
