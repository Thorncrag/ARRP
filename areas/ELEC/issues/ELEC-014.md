...
audit_score: 0
audit_status: "Criminal-scope and statutory-predicate clarification complete; candidate fixed-zero pending primary-record completion, legitimacy assessment, and remedy selection"
audit_last_type: "Criminal-scope and statutory-predicate clarification"
audit_last_date: "2026-07-09"
audit_next: "Identify exact alleged statutes or offense theories for each criminal-process item from primary warrants, returns, subpoenas, orders, DOJ letters, state responses, and Arizona lead verification; keep civil and administrative record demands outside ELEC-014 unless a criminal-process hook is verified; then run T2 remedy-selection and legitimacy assessment"
...
ELEC-014 should begin from a complete criminal-process catalog before judging motive or legitimacy. The current source-development catalog is [ELEC-014 Criminal-Process and State Election Records Catalog](../../../source-development/ELEC-014-criminal-process-catalog.md). It separates core criminal probes, warrants, grand-jury subpoenas, criminal subpoenas, prosecution-warning letters, and unresolved criminal-process leads from noncriminal state-record demands that belong primarily in ELEC-001, ELEC-010, or another proper home unless a criminal-process hook is verified.
...
> —
>
> **Audit Status:** Criminal-scope and statutory-predicate clarification complete; candidate fixed-zero pending primary-record completion, legitimacy assessment, and remedy selection<br />**Last Audit:** Criminal-scope and statutory-predicate clarification<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current-fixed-status`<br />**Next Audit:** Identify exact alleged statutes or offense theories for each criminal-process item from primary warrants, returns, subpoenas, orders, DOJ letters, state responses, and Arizona lead verification; keep civil and administrative record demands outside ELEC-014 unless a criminal-process hook is verified; then run T2 remedy-selection and legitimacy assessment<br />**Full Audit History:** [ELEC-014 audit history](ELEC-014.audit.md)
