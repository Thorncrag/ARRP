...
ELEC-014 should begin from a complete criminal-process catalog before judging motive or legitimacy. The current source-development catalog is [ELEC-014 Criminal-Process and State Election Records Catalog](../../../source-development/ELEC-014-criminal-process-catalog.md). It separates core criminal probes, warrants, grand-jury subpoenas, criminal subpoenas, prosecution-warning letters, and unresolved criminal-process leads from noncriminal state-record demands that belong primarily in [ELEC-004](ELEC-004.md), with ELEC-001 or ELEC-010 cross-references where federal election-control or voter-data architecture is central, unless a criminal-process hook is verified.
