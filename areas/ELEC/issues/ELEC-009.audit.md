...
This file preserves the full audit history for [ELEC-009](ELEC-009.md). The issue page keeps only the compact Proposal Scoring summary.
...
**Score basis:** T1 confirmed that ELEC-009 has a developed issue page, linked constitutional amendment text, budgetary-impact statement, audit sidecar, dashboard row, and source-inventory coverage. The score remains 60 because no full current-rubric component rebaseline has been performed.
