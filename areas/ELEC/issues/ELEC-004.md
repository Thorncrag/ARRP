...
**Manifestation and scope organization.** The concise manifestation section now retains two evidence-bearing episodes: the 2020 post-election litigation wave and the 2025–2026 federal civil voter-data campaign. The [civil-process catalog](../research/ELEC-004-civil-process-catalog.md), rather than the reader-facing section, carries the broader source-development taxonomy for pre-election challenges, civil subpoenas, audits, inspections, record demands, and administrative process. Federal criminal searches, interviews, grand-jury process, and prosecution threats remain assigned to [ELEC-014](ELEC-014.md).
