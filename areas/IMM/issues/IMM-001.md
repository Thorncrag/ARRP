...
The [decision](https://www.supremecourt.gov/opinions/23pdf/23-939_e2pg.pdf) insulated alleged efforts to use DOJ authority to promote sham or pretextual investigations from criminal adjudication, even though the same factual conduct may remain relevant to impeachment, congressional oversight, institutional reform, and the liability of other participants.
...
> —
>
> **Audit Status:** T4 publication-ready audit complete; external validation pending<br />**Last Audit:** T4 publication-ready audit<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current`<br />**Next Audit:** External validation / T4 follow-up<br />**Full Audit History:** [IMM-001 audit history](IMM-001.audit.md)
