...
**Audit process feedback:** The single-issue T1 scope was resource-appropriate and finished under estimate. The audit exposed two workflow improvements now incorporated into the framework: relevant audit results should be visible on the issue page, and each audit should include process feedback so future audit rules can improve from observed friction and outcomes.
