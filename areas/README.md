...
- [A-03 / WAR — War Powers and Military Force](WAR/README.md)
- [A-04 / JUD — Judicial Independence and Enforcement](JUD/README.md)
- [A-05 / PAR — Presidential Clemency and Pardon Power](PAR/README.md)
- [A-06 / EMOL — Presidential Conflicts of Interest and Emoluments](EMOL/README.md)
- [A-07 / CLASS — Classification, Declassification, and National-Security Information](CLASS/README.md)
...
- [A-15 / CONG — Congressional Oversight and Executive Accountability](CONG/README.md)
- [A-16 / IMM — Presidential Immunity and Accountability for Official Misconduct](IMM/README.md)
- [A-17 / REG — Independent Agencies and Regulatory Neutrality](REG/README.md)
- [A-18 / FACT — Government Information, Scientific, Statistical, and Factual Integrity](FACT/README.md)
- [A-19 / RET — Federal Contracting, Grants, Licensing, and Regulatory Retaliation](RET/README.md)
- [A-20 / FED — Federalism and Presidential Coercion of States](FED/README.md)
