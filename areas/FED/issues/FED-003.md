...
issue_id: FED-003
area_id: A-20
title: "Coercive Grant Conditions"
status: candidate
priority: medium
remedy_type: pending-development
audit_score: 0
audit_status: Initial source development complete; remedy and legislation pending
audit_last_type: "Initial source-development pass"
audit_last_date: "2026-07-15"
audit_next: "Existing-law, delegation, grant-conditions, and remedy-selection review"
...
# FED-003 — Coercive Grant Conditions
...
- **FED-003** owns the cross-subject use of federal grants or contracts to obtain State or local policy changes.
- **FED-006** owns direct federal interference with State election systems; the election manifestation belongs here because the operative mechanism is grant leverage.
- **FUND-004** owns selective or retaliatory withholding as a fiscal-administration practice. **FUND-001** applies when the executive fails to obligate or administer funds contrary to an enacted appropriation or mandate.
- **RIGHTS-004** owns substantive immigration-system and due-process defects. FED-003 does not decide whether any sanctuary policy, detainer practice, or immigration-enforcement priority is substantively preferable.
...
> —
>
> **Audit Status:** Initial source development complete; remedy and legislation pending<br />**Last Audit:** Initial source-development pass<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current-fixed-status`<br />**Next Audit:** Existing-law, delegation, grant-conditions, and remedy-selection review<br />**Full Audit History:** [FED-003 audit history](FED-003.audit.md)
