...
> **Proposal Quality Score:** **[70 / 100](DOJ-002.audit.md)** (Substantially Developed Draft)<br />**Adoption Score:** 4 / 12 (Limited Adoption Basis)<br />**Adoption Friction:** 66 / 100 (High Resistance)<br />**Required Electoral Environment:** `current-law-available`<br />**Development Priority:** `active`
>
> —
>
> **Audit Status:** T2 development audit complete; T3 readiness audit pending<br />**Last Audit:** T2 development audit<br />**Rubric Version:** `2026-06-27.1`; **Rebaseline:** `current`<br />**Next Audit:** T3 readiness audit<br />**Full Audit History:** [DOJ-002 audit history](DOJ-002.audit.md)
...
**Quality Score.** The 70/100 score reflects a substantially developed draft with primary-source support for the Minnesota subpoena manifestation, verified Justice Manual analogues, a coherent least-complex internal-policy remedy, and linked proposed manual text. It remains below review-ready status because T2 did not complete full judicial-scrutiny review, external expert review, proposal-specific adoption evidence, detailed overbreadth testing, or a final decision about when codification should replace internal policy.

**Adoption Score.** The 4/12 score is limited because the proposal has a plausible current-law vehicle through DOJ's existing authority to amend the Justice Manual, but it lacks polling, stakeholder evidence, sponsor mapping, or public-support evidence for the specific neutrality-memorandum and Public Integrity approval mechanism.

**Adoption Friction.** The 66/100 score is high because the proposal regulates politically salient criminal-process decisions, White House/DOJ contacts, immigration-adjacent retaliation risk, speech and association burdens, state and local officials, journalism, advocacy organizations, prosecutorial discretion, and likely resistance from executive leadership that prefers flexible case-specific control.

**Required Electoral Environment.** The required environment is `current-law-available` because the core vehicle is a Justice Manual amendment that DOJ leadership could adopt under existing administrative authority. Codification remains a fallback if experience shows internal policy can be suspended, waived, or ignored.
