...
audit_status: T4 publication-ready audit complete; July 23 source update awaiting targeted Change Audit
audit_score: 78
audit_last_type: SCOTUS current-status update
audit_last_date: 2026-07-02
audit_next: "Targeted Change Audit and Internal Remedy-Fit Audit for the July 23 New York Times subpoena withdrawal, followed by qualified review by a DOJ Public Integrity or other career-component practitioner, a public-law attorney, and legislative counsel"
audit_rubric_version: 2026-06-27.2
audit_rebaseline_status: current
change_audit_needed: true
change_audit_reason: "The July 23, 2026 withdrawal of the New York Times journalist and third-party subpoenas materially updates a developed manifestation and requires confirmation that the source basis, framing, and proposed front-end safeguards remain aligned."
...
> —
>
> **Internal Review Status:** Internal project review complete; July 23 source update awaiting revision review<br />**Last Internal Review:** SCOTUS current-status update<br />**Scoring Standard:** `2026-06-27.2`; **Scoring Basis:** The existing score is preserved, but the July 23 manifestation update has not yet received the required consistency and remedy-fit review<br />**Revision Review Needed:** Confirm that the New York Times subpoena withdrawal, the proposal's source basis, and the proposed front-end safeguards remain aligned<br />**Next Review:** Targeted review of the July 23 update, followed by qualified review by a DOJ Public Integrity or other career-component practitioner, a public-law attorney, and legislative counsel<br />**Full Review History:** [DOJ-002 review history](DOJ-002.audit.md)
