...
**Audit scope:** Initial issue-level predicate check for DOJ-004 under rubric `2026-06-27.2`. The audit began from `framework/FRAMEWORK.md`, then `framework/FRAMEWORK.md`, and checked the DOJ-004 issue page, audit sidecar, audit inventory row, source inventory, Audit Dashboard row, and current reporting on the Maurene Comey litigation. This was not a proposal-quality audit because DOJ-004 remains paused pending a controlling merits predicate.
