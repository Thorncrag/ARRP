...
- **HER-003** should own donor-funded or privately financed alteration of federal civic property and should cross-reference [EMOL-series](../EMOL/README.md) issues where donors have business before the federal government.
- **HER-005** should own security or emergency rationales used to avoid preservation and planning review; broader emergency-powers questions remain in [A-10](../EMERG/README.md).
