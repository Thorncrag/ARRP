...
- Donor-funded work should cross-reference [EMOL-001](../EMOL/README.md) where a donor has business before the federal government. Security or emergency rationales should cross-reference [A-10](../EMERG/README.md). Judicial-order evasion belongs in [JUD-001](../JUD/issues/JUD-001.md) only when the evidentiary threshold for executive noncompliance is satisfied.
