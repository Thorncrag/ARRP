...
- **Project 2025 immigration-structure gap.** The [Project 2025 topic guide and crosswalk](../../../topics/project-2025.md), whose overview explains the program's present partisan association and ARRP's issue-by-issue institutional treatment, flags DHS reorganization, mass deportation, interior enforcement expansion, asylum and refugee restrictions, detention, federalism, and immigration-adjudication integrity for routing review. The retired record preserves that history without treating the combined field as one active proposal.
