...
> ## Issue Snapshot
> **Problem:** Humanitarian protections can become unreviewable.<br />**Repair:** Restore reviewable status and asylum safeguards.<br />**Vehicle:** INA and TPS statutory amendments.
>
...
In [*Mullin v. Doe / Trump v. Miot*](https://www.supremecourt.gov/opinions/25pdf/25-1083_f204.pdf), decided June 25, 2026, the Supreme Court held that the TPS statute bars judicial review of non-constitutional claims concerning TPS designation, termination, or extension. The Court also concluded that the Haiti equal-protection claim was unlikely to succeed at the interim-relief stage.
...
[A-14](../../DOM/README.md) should be cross-linked where immigration enforcement, detention, federal law-enforcement deployment, or surveillance mechanics are the primary concern.

[A-10](../../EMERG/README.md) should be cross-linked where border, invasion, national-security, or emergency rhetoric supplies the policy predicate for restricting humanitarian protection.

[JUD-001](../../JUD/issues/JUD-001.md) should be cross-linked only where the executive branch disobeys or evades court orders. RIGHTS-002 is different: it concerns whether courts have statutory authority to review the humanitarian decision in the first place.
...
> **Proposal Quality Score:** **[0 / 100](RIGHTS-002.audit.md)**<br />**Audit Status:** Pending development; no proposal-quality score assigned<br />**Last Audit:** Horizon integration decision<br />**Rubric Version:** `2026-06-27.1`; **Rebaseline:** `current-fixed-status`<br />**Required Electoral Environment:** `N/A`<br />**Development Priority:** `N/A`<br />**Adoption Friction:** `N/A`<br />**Next Audit:** Source-development pass<br />**Full Audit History:** [RIGHTS-002 audit history](RIGHTS-002.audit.md)
