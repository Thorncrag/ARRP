...
audit_score: 82
audit_status: "T4 publication-ready audit complete; qualified external review and current-case refresh required"
audit_last_type: "T4 publication-ready audit"
audit_last_date: "2026-07-13"
audit_next: "Qualified constitutional, legislative-counsel, judicial-administration, appropriations, and CBO review / T4 follow-up"
...
Institutional conservatives may object to D.D.C. concentration, a national roster, new judgeships, direct spending, and perceived court packing. The Judiciary's [2024 random-assignment policy](https://www.uscourts.gov/data-news/judiciary-news/2024/03/12/conference-acts-promote-random-case-assignment) supports the anti-judge-shopping premise, while its [2025 generalist-judge discussion](https://www.uscourts.gov/data-news/reports/annual-reports/directors-annual-report/annual-report-2025/court-operations-annual-report-2025) supplies a good-faith objection to concentrating subject-specific cases in a designated group. Federalism advocates may object that exclusive D.D.C. jurisdiction burdens State and local plaintiffs. Civil-liberties advocates may object to expedited discovery and protected-information procedures. Administrators may object to short emergency schedules and recurring compliance reports. The draft responds with a randomly assigned D.D.C. judge, a randomly selected and assigned cross-circuit roster, active-judge consent, senior-judge willingness, ordinary judicial offices, public rules, ordinary recusal law, a bounded deadline extension, one launch judgeship and a workload-contingent second seat, ordinary appeal periods, and plaintiff-complete rather than universal relief. These safeguards reduce but do not eliminate forum, generalist, cost, legitimacy, and workload objections.
...
> —
>
> **Audit Status:** T4 publication-ready audit complete; qualified external review and current-case refresh required<br />**Last Audit:** T4 publication-ready audit (2026-07-13)<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current`<br />**Change Audit:** Current for the general civil cause, shared-infrastructure extension, independent-alternative convention, and affected-issue presentation<br />**Next Audit:** Qualified constitutional, legislative-counsel, judicial-administration, appropriations, and CBO review / T4 follow-up<br />**Full Audit History:** [JUD-011 audit history](JUD-011.audit.md)
