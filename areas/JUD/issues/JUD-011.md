...
Budget authority is likely required for two additional D.D.C. judgeships, clerk and staff capacity, facilities, technology, secure records, special masters, and emergency administration. The working draft proposes $10 million in startup direct spending and $15 million annually for seven years for the base civil framework. CBO's H.R. 1702 comparator supports the scale of ordinary judgeship compensation and court administration but does not estimate this framework. D.D.C.'s March 2025 profile reported 15 authorized judgeships, 4,311 annual filings, 6,464 pending matters, and 309 weighted filings per judgeship; the Judicial Conference's 2025 national recommendations did not request another D.D.C. seat. The two proposed seats therefore rest on expected new-program capacity rather than a demonstrated ordinary-caseload shortage and require AOUSC workload validation and the Act's three-year capacity review. A later specialized implementing Act must expressly authorize incremental use and separately provide function-specific funding, including investigative operations under DOJ-007. No official JUD-011 cost estimate is available.

*Note: Preliminary ARRP assessment only; not a CBO, OMB, agency, or legislative-counsel score.*

## Proposal Scoring

> **Proposal Quality Score:** **[70 / 100](JUD-011.audit.md)** (Developed Draft)<br />**Adoption Score:** 2 / 12 (Weak Adoption Basis)<br />**Adoption Friction:** 87 / 100 (Extreme Resistance)<br />**Required Electoral Environment:** `sixty-vote-senate`<br />**Development Priority:** `active`
>
> —
>
> **Audit Status:** T2 development audit complete; T3 readiness audit pending<br />**Last Audit:** T2 development audit (2026-07-13)<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current`<br />**Change Audit:** Current for the general civil cause, shared-infrastructure extension, independent-alternative convention, and affected-issue presentation<br />**Next Audit:** T3 readiness audit<br />**Full Audit History:** [JUD-011 audit history](JUD-011.audit.md)

## Annotation

**Quality Score.** T2 raises JUD-011 to 70 / 100 while retaining Developed Draft status. The review verified bounded congressional-standing precedents, the sovereign-immunity model, temporary-assignment statutes, three-judge and specialized-roster analogues, current remedial limits, a prior House-passed accountability package, and current judicial cost and workload comparators. The bill now identifies responsible officers and successors in mandatory decrees, directly authorizes random roster assignments while preserving source-circuit consent, and limits injunctions to complete plaintiff relief. T3 must test the complete draft against procedural rules and current merits litigation, conduct section-by-section legislative-form review, deepen adoption and opposition evidence, and resolve whether two D.D.C. judgeships are justified at launch.

**Adoption Score.** Adoption remains 2 / 12. H.R. 5314's House passage and 168 cosponsors show that a broad executive-accountability package can reach one chamber under unified partisan support, while the narrower 119th-Congress bills establish a continuing sponsor pool. The record still lacks bipartisan passage, a direct JUD-011 sponsor, proposal-specific polling, an institutional validator, or evidence that the Senate would accept the general cause, roster, judgeships, and protected direct spending.
