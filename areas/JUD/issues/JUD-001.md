...
audit_status: "T4 complete; JUD-005 public-notice integration Change Audit complete; external validation pending"
audit_score: 78
audit_last_type: "JUD-005 public-notice integration Change Audit"
audit_last_date: "2026-07-14"
audit_next: "External validation / T4 follow-up, including public-register administration"
...
Persistent or willful noncompliance should trigger simultaneous notice to the relevant inspector general, the Attorney General, congressional majority and minority recipients, and the Administrative Office of the United States Courts. A searchable register should display the public finding and give equal prominence to a later stay, reversal, vacatur, modification, or compliance determination. This [JUD-005](JUD-005.md) function is informational and remedial, not a substitute for judicial enforcement or an automatic investigative referral.
...
> —
>
> **Audit Status:** T4 complete; JUD-005 public-notice integration Change Audit complete; external validation pending<br />**Last Audit:** JUD-005 public-notice integration Change Audit (2026-07-14)<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current`<br />**Next Audit:** External validation / T4 follow-up, including public-register administration<br />**Full Audit History:** [JUD-001 audit history](JUD-001.audit.md)
