...
audit_score: 63
audit_status: "T1 framework check complete; T2 source and legal-fit audit pending"
audit_last_type: "T1 framework check"
audit_last_date: "2026-07-15"
audit_next: "T2 audit of Title 28 coverage, trigger and status-event precision, protected information, congressional distribution, workload, current proposals, and JUD-001 fit"
...
> —
>
> **Audit Status:** T1 framework check complete; T2 source and legal-fit audit pending<br />**Last Audit:** T1 framework check (2026-07-15)<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current`<br />**Next Audit:** T2 review of Title 28 coverage, trigger and status-event precision, protected information, congressional distribution, workload, current proposals, and JUD-001 fit<br />**Full Audit History:** [JUD-005 audit history](JUD-005.audit.md)
