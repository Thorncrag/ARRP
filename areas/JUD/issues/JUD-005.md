...
> ## Issue Snapshot
> **Problem:** Judicial findings of executive noncompliance lack uniform public notice to Congress.<br />**Repair:** Require simultaneous congressional transmission, a searchable public register, and later status updates.<br />**Vehicle:** Use [JUD-001](JUD-001.md) with conditional [DOJ-007](../../DOJ/issues/DOJ-007.md) escalation (preferred), or [standalone Act](../../../legislation/JUD-005.md) (alternative).
>
