...
audit_last_type: "Initial statutory draft and remedy-scope clarification"
audit_last_date: "2026-07-13"
audit_next: "T1 audit of coverage, deadlines, withholding safeguards, remedies, and implementation"
...
## Why Evidence Access Is Necessary to Test Immunity
...
17. anti-circumvention rules preventing an agency from defeating access through transfer, relabeling, outsourcing, record-system design, or directing another federal component to retain exclusive custody;
...
- **Current status:** Initial statutory draft complete; T1 legal-durability and implementation audit pending.
...
DOM-008 is adjacent because disputes over withheld evidence require expedited judicial review. DOM-005 should nevertheless contain its own incident-specific enforcement mechanism rather than depend on a general judicial-review proposal.
...
[RIGHTS-004](../../RIGHTS/issues/RIGHTS-004.md) should cross-reference DOM-005 when immigration enforcement produces a covered use-of-force incident. DOM-005 must remain agency-neutral and should apply equally to ICE, CBP, the FBI, ATF, DEA, the U.S. Marshals Service, the Secret Service, federal protective forces, joint task forces, and other covered personnel.
...
No reliable estimate is available before an implementation and budget audit. Material costs may include secure evidence retention, authentication, duplication and transmission, State forensic participation or reimbursement, inspector-general and aggregate compliance reporting, agency compliance personnel, protective-order administration, and expedited Federal-court workload. The draft does not fund or require new body-worn-camera equipment.
...
> —
>
> **Audit Status:** First statutory draft complete; T1 audit pending<br />**Last Audit:** Initial statutory draft and remedy-scope clarification<br />**Rubric Version:** `2026-06-27.2`; **Rebaseline:** `current-fixed-status`<br />**Next Audit:** T1 audit of coverage, deadlines, withholding safeguards, remedies, and implementation<br />**Full Audit History:** [DOM-005 audit history](DOM-005.audit.md)

## Annotation

DOM-005 remains a candidate and receives a fixed score of 0 because the new first draft has not undergone a T1 audit and the proposal still lacks a full primary-source survey, a privilege and criminal-procedure memorandum, a cost model, and an adoption pathway.
