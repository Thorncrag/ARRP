...
| Authority | Verified rule | Draft consequence |
| --- | --- | --- |
| Article III; *Steel Co. v. Citizens for a Better Environment*, 523 U.S. 83 (1998) | A federal court may not assume hypothetical jurisdiction to decide merits questions. | The filing court first determines coverage and adversity; Congress does not purport to create a case or controversy. A non-adverse action is dismissed without prejudice. |
| [Federal Rule of Civil Procedure 41(a)(1)(A)](https://www.uscourts.gov/forms-rules/current-rules-practice-procedure/federal-rules-civil-procedure) | A notice or stipulation is self-executing only subject to specified Rules and any applicable federal statute. | EMOL-015 expressly makes itself an applicable federal statute and makes a dismissal filing ineffective until screening. |
| *Anago Franchising, Inc. v. Shaz, LLC*, 677 F.3d 1272 (11th Cir. 2012) | An otherwise valid Rule 41(a)(1) stipulation is self-executing and ordinarily ends merits jurisdiction. | The bill must alter the filing's legal effectiveness directly, not rely only on residual jurisdiction after a valid dismissal. |
| *O'Neal v. American Shaman Franchise Systems, Inc.*, No. 24-10900 (11th Cir. Feb. 11, 2026) | The published opinion and concurrence distinguish a Rule 41 filing governed by an applicable federal statute; the concurrence explains why an invalid FLSA dismissal does not obtain self-executing effect. | This is a current in-circuit functional analogue for Congress conditioning voluntary dismissal, although its detailed Rule 41 discussion is concurring rather than the majority's holding. |
| *Cooter & Gell v. Hartmarx Corp.*, 496 U.S. 384 (1990) | A valid Rule 41 dismissal ends merits jurisdiction but does not eliminate authority over collateral Rule 11 sanctions, costs, and similar matters. | After threshold dismissal, EMOL-015 confines residual judicial work to lawful collateral matters; tolling and payment restrictions operate by statute rather than continuing merits jurisdiction. |
...
1. Coverage disclosure, the statutory interim prohibition, and tolling activate without an executive objection.
2. The filing court determines jurisdiction and adversity sua sponte before merits action.
3. If adversity is absent, dismissal is mandatory and no purported settlement receives judicial approval or incorporation.
...
- whether every application of the Rule 41 delay is procedural and constitutional when adversity is absent from inception;
